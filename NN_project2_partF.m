...
Emkvk = (1/3) * ((1.2 * sin(((2 * pi * 1) / 3) - (pi / 2)) * 1.2 * sin((2 * pi * 1) / 3)) + (1.2 * sin(((2 * pi * 2) / 3) - (pi / 2)) * 1.2 * sin((2 * pi * 2) / 3)) + (1.2 * sin(((2 * pi * 3) / 3) - (pi / 2)) * 1.2 * sin((2 * pi * 3) / 3)));
Esmkvk1 = (1/3) * ((1.2 * sin(((2 * pi * 1) / 3) - (pi / 2)) * 1.2 * sin((2 * pi * 0) / 3)) + (1.2 * sin(((2 * pi * 2) / 3) - (pi / 2)) * 1.2 * sin((2 * pi * 1) / 3)) + (1.2 * sin(((2 * pi * 3) / 3) - (pi / 2)) * 1.2 * sin((2 * pi * 2) / 3)));
